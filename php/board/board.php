                 ...
                 <div class="board__search">
                    <form action="boardSearch.php" name="boardSearch" method="get">
                        <fieldset>
                            ...
                            <div>
                                <input type="search" name="searchKeyword" class="search-form" placeholder="검색어를 입력하세요!" aria-label="search" requierd >
                            </div>
                            <div>
...
?>
                 ...
                 <div class="board__pages">
                     <ul>
<?php
  require "boardPage.php"; //에러 있으면 멈춘다.
//   include "boardPage.php"; //에러 있어도 
//   require_once "boardPage.php"; //한번만

?>
                         <!-- <li><a href="#">처음으로</a></li>
                         <li><a href="#">이전</a></li>
                         <li><a href="board.php?page=1" class="active">1</a></li>
                         ...
                         <li><a href="board.php?page=8">마지막으로</a></li> -->
                     </ul>
                 </div>
             </div>
          </div>
