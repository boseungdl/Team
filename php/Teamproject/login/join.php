        ...
        <main id="contents">
                ...
                <section class="join-type gray">
                    ...
                    <div class="logo"><img src="../assets/img/Logo.png" alt="로고"></div>
                        ...
                        <div class="social">
                            <div class="google">
                                <a href=#><img src="../assets/img/google.png" alt="구글">구글</a></div>
                            <div class="naver">
                                <a href=#><img src="../assets/img/naver.png" alt="네이버">네이버</a></div>
                            <div class="kakao">
                                <a href=#><img src="../assets/img/kakao.png" alt="카카오톡">카카오톡</a></div>
                        </div>
                        <div class="or">Or</div>
