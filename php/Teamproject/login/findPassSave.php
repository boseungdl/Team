<?php
    ...
    // 아이디 체크
    $sql = "SELECT youPass, youName, youEmail, youPhone FROM myTeam WHERE youName = '$youName' AND youEmail = '$youEmail' AND youPhone = '$youPhone'";
    ...
    if($findInfo['youName'] == $youName && $findInfo['youEmail'] == $youEmail && $findInfo['youPhone'] == $youPhone){
        ...
        echo "<script>alert('틀림'); history.back(1)</script>";
    }
?>
<!DOCTYPE html>
<html lang="ko">
                    ...
                    <fieldset>
                        ...
                        <div class="login-box">
                            ...
                            <div class="mt10">
                                ...
                                <input type="password" id="youPassC" name="youPassC" maxlength="20" placeholder="다시 한번 비밀번호를 적어주세요!" autocomplete="off" required>
                            </div>
                        </div>
